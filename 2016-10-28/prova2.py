            ...
            for adiacente in adiacents:
                ...
                if color[vertsConvessi.index(adiacente)] == 0:
                    ...
                    if occorrenzaConvessi(adiacente,verts,facciate) <= 1:
                        print adiacente,":",occorrenzaConvessi(adiacente,verts,facciate)
...
verts = [[0,14,0],[0,8,0],[2,11,2],[4,22,0],[4,14,0],[4,8,0],[4,0,0],[8,20,2],[8,11,2],[8,2,2],[12,22,0],[12,14,0],[12,8,0],[12,0,0],[14,11,2],[16,14,0],[16,8,0]]
cells = [[1,2,3,5,6,9],[4,11,8,5,9,12],[12,16,17,15,13,9],[7,14,10,6,13,9]]


VIEW(ggpl_my_roof_builder(verts,cells))