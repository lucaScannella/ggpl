...
ANGOLO = PI/3
COSTANTE_DI_TAGLIO = 0.1
TERRACE_TEXTURE = ["terrace_texture.jpg",True,False,1,1,0,10,10]

def tetto_terrazzo(angolo,perimetro,cost,showTerrace):
    perimetro = UKPOL(perimetro)
    vertici = perimetro[0]
    celle = perimetro[1]
    vertici = cleanVerts(vertici)
    roof = make_roof(vertici,celle,angolo,cost,showTerrace)
...
tetto1 = tetto_terrazzo(ANGOLO,perimetro1,COSTANTE_DI_TAGLIO,1)

perimetro2 = MKPOL([[[0,0,0],[2,0,0],[4,4,0],[3,6,0],[0,4,0],[6,6,0],[6,4,0]],[[1,2,3,4,5],[3,4,6,7]],1])
tetto2 = tetto_terrazzo(ANGOLO,perimetro2,COSTANTE_DI_TAGLIO,1)

perimetro3 = MKPOL([[[2,0,0],[4,2,0],[4,8.5,0],[0,5,0],[0,2,0],[6,0,0],[8,2,0],[8,5,0]],[[1,2,3,4,5],[2,3,6,7,8]],1])
tetto3 = tetto_terrazzo(ANGOLO,perimetro3,COSTANTE_DI_TAGLIO,1)
